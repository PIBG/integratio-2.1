...
<head>
    ...
    <title>PIBG Admin - Ministerio Integração</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">PIBG System</a>
            </div>
            <!-- Top Menu Items -->
                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Nome" name="nome" requere>
                            </div>                         
                            <div class="form-group">
                   ...
                   <div class="row">                   
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="sexo" id="optionsRadios1" value="Maculino"requere>Masculino  <b> </b>
                                    </label>
                                   
                                    <label>
                                        <input type="radio" name="sexo" id="optionsRadios2" value="Feminino" requere>Feminino
                                    </label>
                                </div>                                
                            </div>
                       </div>
                        ...
                        <div class="col-lg-3">
                             <div class="form-group">
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="estado" id="optionsRadios1" value="Casado" requere>Casado  <b> </b>
                                    </label>
                                    <b> </b>
                                    <label>
                                        <input type="radio" name="estado" id="optionsRadios2" value="Solteiro" requere>Solteiro
                                    </label>
                                </div>                                
                            </div> 
                       </div>
...
<script type="text/javascript">
        function habilitaBtn () {
            ...
            if(op == "--")
            {
                ...
                document.getElementById('avancars').style.display='none'; document.getElementById('avancarlabel').style.display='none';
            ...
            else if(op == "2")
            {
                ...
                document.getElementById('avancars').style.display='none';document.getElementById('avancarlabel').style.display='block';
                 
            }
            else
                 {
                if(document.getElementById('avancars').style.display) document.getElementById('avancar').style.display='none'
                document.getElementById('avancars').style.display='block';document.getElementById('avancarlabel').style.display='none';
                document.getElementById('avancar').value=''; 
            }
        }
    </script>
    ...
    <fieldset>  
      <label>TIPO</label>         
        <select class="form-control" onchange="habilitaBtn()" id="opcao" nome="tipo">
       ...
       <div class="form-group">
         <label style="display:none;" id="avancarlabel">Decisão Do Discipulo</label>
           <select class="form-control" style="display:none;" id="avancar" type="text" nome="estadodsr">
        ...
        <div class="form-group">
         <label style="display:none;" id="avancarlabels">Estado Discipulador</label>
           <select class="form-control" style="display:none;" id="avancars" type="text" nome="estadodsr">
            <option value='' selected>Selecione</option>
